...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().titleTextAttributes = [
            NSFontAttributeName: UIFont(name: "MuseoSansRounded-700", size: 28)!, NSForegroundColorAttributeName : UIColor.white
        ]
        ...
        SVProgressHUD.setDefaultAnimationType(SVProgressHUDAnimationType.flat)
         NotificationCenter.default.addObserver(self, selector: #selector(hideProgressHud), name: NSNotification.Name.SVProgressHUDDidReceiveTouchEvent, object: nil)
        ...
        if url.scheme == "cando" {
            ...
            if userDict!["action"] == "register" {
                ...
                if let navigationController = window?.rootViewController as? BaseAuthNavigationController{
                    ...
                    let storyboard = UIStoryboard(name: "Main", bundle: nil)
                    let vc = storyboard.instantiateViewController(withIdentifier: "newPasswordViewController") as! SetNewPasswordViewController
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "bvb.CanDo" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "CanDo", withExtension: "momd")!
